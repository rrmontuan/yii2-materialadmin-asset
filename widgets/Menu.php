...
class Menu extends \yii\widgets\Menu
{
     ...
     * @inheritdoc
     */
    public $linkTemplate = '<a href="{url}" {active}>{icon} {label}</a>';
    /**
     * @inheritdoc
     ...
     */
    public static $iconClassPrefix = 'md md-';
    ...
    protected function renderItem($item)
    {
        ...
        $replacements = [
            ...
            '{icon}' => empty($item['icon']) ? $this->defaultIconHtml : '<i class="' . self::$iconClassPrefix . $item['icon'] . '"></i> ',
    ...
    protected function renderItems($items)
    {
        ...
        foreach ($items as $i => $item) {
            ...
            if ($item['active']) {
                ...
                $class[] = (!empty($item['items'])) ? 'toggled' : '';
            }
